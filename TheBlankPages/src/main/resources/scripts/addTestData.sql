...
insert into ADDRESS (street, additionalInfo, cityinfo_id) values ("street1", "additionalInfo1", 1);
insert into ADDRESS (street, additionalInfo, cityinfo_id) values ("street2", "additionalInfo2", 2);
insert into ADDRESS (street, additionalInfo, cityinfo_id) values ("street3", "additionalInfo3", 3);
